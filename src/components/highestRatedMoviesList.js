import { useFetchHighestRatedMoviesQuery } from "../store";//import hook
import MovieCard from "./movieCard"

function HighestRatedMoviesList() {                                   //Bemærk Query-function kaldes automatisk når komponenten bliver displayed
...
let content; // 
  if (isFetching) {
    ...
    content = data.results
          .filter(movie => movie.poster_path !== null && movie.vote_average !== 0) //filter film uden poster og med rating på 0
